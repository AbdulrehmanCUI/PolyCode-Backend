...
- Understand **asp.net core intro** in C#
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

ASP.NET Core Intro is a core topic on the PolyCode **C# Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```csharp
// ASP.NET Core Intro — practice sketch
// add your code here
```
