# Lesson 07 — Entity Framework Intro
...
- Understand **entity framework intro** in C#
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Entity Framework Intro is a core topic on the PolyCode **C# Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```csharp
// Entity Framework Intro — practice sketch
// add your code here
```
