...
- Understand **hello world** in C#
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Hello World is a core topic on the PolyCode **C# Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
Save as `03-hello-world.cs` and run it in your environment or the PolyCode Playground.
