# Lesson 04 — Software Architecture
...
- Understand **software architecture** in C#
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Software Architecture is a core topic on the PolyCode **C# Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```csharp
// Software Architecture — practice sketch
// add your code here
```
