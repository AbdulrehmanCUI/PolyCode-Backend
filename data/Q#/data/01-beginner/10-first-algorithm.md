# Lesson 10 — First Quantum Algorithm
...
- Understand **first quantum algorithm** in Q#
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

First Quantum Algorithm is a core topic on the PolyCode **Q# Certificate Course** path. Work through the examples, then try the exercise before moving on.

## Key concepts

1. **Syntax and structure** — how Q# expresses this idea clearly
...
```md
// First Quantum Algorithm — practice sketch
// add your code here
```
