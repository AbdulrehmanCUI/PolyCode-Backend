# Lesson 05 — Azure Quantum Workspace
...
- Understand **azure quantum workspace** in Q#
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Azure Quantum Workspace is a core topic on the PolyCode **Q# Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```md
// Azure Quantum Workspace — practice sketch
// add your code here
```
