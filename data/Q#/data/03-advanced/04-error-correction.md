# Lesson 04 — Error Correction Intro
...
- Understand **error correction intro** in Q#
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Error Correction Intro is a core topic on the PolyCode **Q# Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```md
// Error Correction Intro — practice sketch
// add your code here
```
