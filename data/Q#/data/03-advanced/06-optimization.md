# Lesson 06 — Quantum Optimization
...
- Understand **quantum optimization** in Q#
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Quantum Optimization is a core topic on the PolyCode **Q# Certificate Course** path. Work through the examples, then try the exercise before moving on.
