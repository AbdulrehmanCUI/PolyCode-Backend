...
- Understand **complex automation** in Batchfile
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Complex Automation is a core topic on the PolyCode **Batchfile Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```bat
REM Complex Automation — practice sketch
