# Lesson 05 — Virtual Environments and pip
...
- Understand **virtual environments and pip** in Python
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Virtual Environments and pip is a core topic on the PolyCode **Python Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```py
# Virtual Environments and pip — practice sketch
# add your code here
```
