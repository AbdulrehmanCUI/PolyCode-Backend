...
- Understand **json and apis** in Python
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

JSON and APIs is a core topic on the PolyCode **Python Certificate Course** path. Work through the examples, then try the exercise before moving on.
