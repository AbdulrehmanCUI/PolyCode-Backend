...
Object-Oriented Programming is a core topic on the PolyCode **Python Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```py
# Object-Oriented Programming — practice sketch
# add your code here
```
