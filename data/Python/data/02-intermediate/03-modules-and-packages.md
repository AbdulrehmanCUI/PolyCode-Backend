# Lesson 03 — Modules and Packages
...
Modules and Packages is a core topic on the PolyCode **Python Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```py
# Modules and Packages — practice sketch
# add your code here
```
