...
- Understand **file i/o basics** in Python
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

File I/O Basics is a core topic on the PolyCode **Python Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```py
# File I/O Basics — practice sketch
# add your code here
```
