...
- Understand **introduction to python** in Python
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Introduction to Python is a core topic on the PolyCode **Python Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```py
# Introduction to Python — practice sketch
# add your code here
```
