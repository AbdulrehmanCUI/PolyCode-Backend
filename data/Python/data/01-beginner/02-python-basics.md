# Lesson 02 — Python Basics and Syntax
...
- Understand **python basics and syntax** in Python
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Python Basics and Syntax is a core topic on the PolyCode **Python Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```py
# Python Basics and Syntax — practice sketch
# add your code here
```
