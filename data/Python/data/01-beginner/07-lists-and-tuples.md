...
Lists and Tuples is a core topic on the PolyCode **Python Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```py
# Lists and Tuples — practice sketch
# add your code here
```
