...
- Understand **deployment basics** in Python
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Deployment Basics is a core topic on the PolyCode **Python Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```py
# Deployment Basics — practice sketch
# add your code here
```
