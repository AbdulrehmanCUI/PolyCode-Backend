...
- Understand **flask web basics** in Python
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Flask Web Basics is a core topic on the PolyCode **Python Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```py
# Flask Web Basics — practice sketch
# add your code here
```
