# Lesson 04 — Data Analysis with Pandas
...
- Understand **data analysis with pandas** in Python
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Data Analysis with Pandas is a core topic on the PolyCode **Python Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```py
# Data Analysis with Pandas — practice sketch
# add your code here
```
