# Lesson 03 — SQLite and Databases
...
- Understand **sqlite and databases** in Python
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

SQLite and Databases is a core topic on the PolyCode **Python Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```py
# SQLite and Databases — practice sketch
# add your code here
```
