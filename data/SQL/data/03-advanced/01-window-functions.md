...
Window Functions is a core topic on the PolyCode **SQL Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```sql
-- Window Functions — practice sketch
-- add your code here
```
