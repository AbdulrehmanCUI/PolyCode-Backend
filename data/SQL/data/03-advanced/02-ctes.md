# Lesson 02 — Common Table Expressions
...
- Understand **common table expressions** in SQL
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Common Table Expressions is a core topic on the PolyCode **SQL Certificate Course** path. Work through the examples, then try the exercise before moving on.

## Key concepts

1. **Syntax and structure** — how SQL expresses this idea clearly
...
```sql
-- Common Table Expressions — practice sketch
-- add your code here
```
