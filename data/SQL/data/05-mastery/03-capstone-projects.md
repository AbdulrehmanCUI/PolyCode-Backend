...
- Understand **capstone projects** in SQL
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Capstone Projects is a core topic on the PolyCode **SQL Certificate Course** path. Work through the examples, then try the exercise before moving on.
