...
- Understand **performance tuning** in SQL
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Performance Tuning is a core topic on the PolyCode **SQL Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```sql
-- Performance Tuning — practice sketch
-- add your code here
```
