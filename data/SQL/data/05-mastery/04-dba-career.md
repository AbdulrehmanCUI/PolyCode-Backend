...
- Understand **dba career path** in SQL
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

DBA Career Path is a core topic on the PolyCode **SQL Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```sql
-- DBA Career Path — practice sketch
-- add your code here
```
