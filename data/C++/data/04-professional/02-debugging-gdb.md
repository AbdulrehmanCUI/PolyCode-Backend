...
- Understand **debugging with gdb** in C++
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Debugging with GDB is a core topic on the PolyCode **C++ Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```cpp
// Debugging with GDB — practice sketch
// add your code here
```
