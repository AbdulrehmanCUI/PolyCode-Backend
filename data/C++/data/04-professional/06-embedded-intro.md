# Lesson 06 — Embedded Systems Intro
...
- Understand **embedded systems intro** in C++
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Embedded Systems Intro is a core topic on the PolyCode **C++ Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```cpp
// Embedded Systems Intro — practice sketch
// add your code here
```
