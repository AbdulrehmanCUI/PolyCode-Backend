...
Multithreading is a core topic on the PolyCode **C++ Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```cpp
// Multithreading — practice sketch
// add your code here
```
