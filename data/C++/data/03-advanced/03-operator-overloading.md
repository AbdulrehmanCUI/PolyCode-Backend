# Lesson 03 — Operator Overloading
...
Operator Overloading is a core topic on the PolyCode **C++ Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```cpp
// Operator Overloading — practice sketch
// add your code here
```
