# Lesson 05 — Templates Introduction
...
- Understand **templates introduction** in C++
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Templates Introduction is a core topic on the PolyCode **C++ Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```cpp
// Templates Introduction — practice sketch
// add your code here
```
