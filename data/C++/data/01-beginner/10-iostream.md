...
Input and Output is a core topic on the PolyCode **C++ Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```cpp
// Input and Output — practice sketch
// add your code here
```
