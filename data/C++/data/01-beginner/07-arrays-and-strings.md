...
- Understand **arrays and strings** in C++
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Arrays and Strings is a core topic on the PolyCode **C++ Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```cpp
// Arrays and Strings — practice sketch
// add your code here
```
