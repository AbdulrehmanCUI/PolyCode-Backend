...
- Understand **authentication** in Ruby
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Authentication is a core topic on the PolyCode **Ruby Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```rb
# Authentication — practice sketch
# add your code here
```
