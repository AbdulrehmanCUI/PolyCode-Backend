...
- Understand **api-only rails** in Ruby
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

API-Only Rails is a core topic on the PolyCode **Ruby Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```rb
# API-Only Rails — practice sketch
# add your code here
```
