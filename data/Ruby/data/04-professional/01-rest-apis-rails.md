# Lesson 01 — REST APIs with Rails
...
- Understand **rest apis with rails** in Ruby
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

REST APIs with Rails is a core topic on the PolyCode **Ruby Certificate Course** path. Work through the examples, then try the exercise before moving on.

## Key concepts

1. **Syntax and structure** — how Ruby expresses this idea clearly
...
```rb
# REST APIs with Rails — practice sketch
# add your code here
```
