# Lesson 04 — Freelance and Career Guide
...
- Understand **freelance and career guide** in PHP
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Freelance and Career Guide is a core topic on the PolyCode **PHP Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```php
// Freelance and Career Guide — practice sketch
// add your code here
```
