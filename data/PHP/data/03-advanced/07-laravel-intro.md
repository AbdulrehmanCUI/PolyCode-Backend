# Lesson 07 — Laravel Introduction
...
- Understand **laravel introduction** in PHP
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Laravel Introduction is a core topic on the PolyCode **PHP Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```php
// Laravel Introduction — practice sketch
// add your code here
```
