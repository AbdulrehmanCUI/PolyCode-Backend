...
- Understand **php security** in PHP
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

PHP Security is a core topic on the PolyCode **PHP Certificate Course** path. Work through the examples, then try the exercise before moving on.
