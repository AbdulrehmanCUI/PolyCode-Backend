# Lesson 04 — Sessions and Cookies
...
- Understand **sessions and cookies** in PHP
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Sessions and Cookies is a core topic on the PolyCode **PHP Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```php
// Sessions and Cookies — practice sketch
// add your code here
```
