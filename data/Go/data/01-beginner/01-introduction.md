...
- Understand **introduction to go** in Go
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Introduction to Go is a core topic on the PolyCode **Go Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```go
// Introduction to Go — practice sketch
// add your code here
```
