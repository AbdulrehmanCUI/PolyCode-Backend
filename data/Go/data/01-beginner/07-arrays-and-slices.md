...
Arrays and Slices is a core topic on the PolyCode **Go Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```go
// Arrays and Slices — practice sketch
// add your code here
```
