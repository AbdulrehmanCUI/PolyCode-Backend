# Lesson 07 — Security Best Practices
...
- Understand **security best practices** in Go
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Security Best Practices is a core topic on the PolyCode **Go Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```go
// Security Best Practices — practice sketch
// add your code here
```
