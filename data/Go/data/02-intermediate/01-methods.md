# Lesson 01 — Methods and Receivers
...
- Understand **methods and receivers** in Go
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Methods and Receivers is a core topic on the PolyCode **Go Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```go
// Methods and Receivers — practice sketch
// add your code here
```
