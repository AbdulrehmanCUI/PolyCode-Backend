# Lesson 06 — Foreign Function Interface
...
- Understand **foreign function interface** in Rust
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Foreign Function Interface is a core topic on the PolyCode **Rust Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```rs
// Foreign Function Interface — practice sketch
// add your code here
```
