...
- Understand **data structures** in Rust
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Data Structures is a core topic on the PolyCode **Rust Certificate Course** path. Work through the examples, then try the exercise before moving on.
