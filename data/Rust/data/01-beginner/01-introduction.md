# Lesson 01 — Introduction to Rust
...
- Understand **introduction to rust** in Rust
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Introduction to Rust is a core topic on the PolyCode **Rust Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```rs
// Introduction to Rust — practice sketch
// add your code here
```
