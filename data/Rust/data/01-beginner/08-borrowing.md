# Lesson 08 — Borrowing and References
...
- Understand **borrowing and references** in Rust
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Borrowing and References is a core topic on the PolyCode **Rust Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```rs
// Borrowing and References — practice sketch
// add your code here
```
