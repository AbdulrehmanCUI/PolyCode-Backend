# Lesson 10 — Enums and Pattern Matching
...
- Understand **enums and pattern matching** in Rust
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Enums and Pattern Matching is a core topic on the PolyCode **Rust Certificate Course** path. Work through the examples, then try the exercise before moving on.

## Key concepts

1. **Syntax and structure** — how Rust expresses this idea clearly
...
```rs
// Enums and Pattern Matching — practice sketch
// add your code here
```
...
**Next:** Continue to lesson 11 in this module.
