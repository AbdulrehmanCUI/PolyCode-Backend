# Lesson 01 — Inheritance and Polymorphism
...
Inheritance and Polymorphism is a core topic on the PolyCode **Java Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```java
// Inheritance and Polymorphism — practice sketch
// add your code here
```
