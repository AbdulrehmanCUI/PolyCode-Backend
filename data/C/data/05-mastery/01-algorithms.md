...
- Understand **advanced algorithms** in C
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Advanced Algorithms is a core topic on the PolyCode **C Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```c
// Advanced Algorithms — practice sketch
// add your code here
```
