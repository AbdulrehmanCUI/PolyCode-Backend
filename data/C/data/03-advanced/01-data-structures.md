# Lesson 01 — Data Structures in C
...
- Understand **data structures in c** in C
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Data Structures in C is a core topic on the PolyCode **C Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```c
// Data Structures in C — practice sketch
// add your code here
```
