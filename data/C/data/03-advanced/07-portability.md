# Lesson 07 — Portability and Standards
...
- Understand **portability and standards** in C
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Portability and Standards is a core topic on the PolyCode **C Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```c
// Portability and Standards — practice sketch
// add your code here
```
