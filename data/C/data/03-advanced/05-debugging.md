# Lesson 05 — Debugging C Programs
...
- Understand **debugging c programs** in C
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Debugging C Programs is a core topic on the PolyCode **C Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```c
// Debugging C Programs — practice sketch
// add your code here
```
