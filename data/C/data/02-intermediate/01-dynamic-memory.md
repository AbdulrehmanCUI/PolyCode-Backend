...
Dynamic Memory is a core topic on the PolyCode **C Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```c
// Dynamic Memory — practice sketch
// add your code here
```
