...
Function Pointers is a core topic on the PolyCode **C Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```c
// Function Pointers — practice sketch
// add your code here
```
