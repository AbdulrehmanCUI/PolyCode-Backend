...
Bitwise Operations is a core topic on the PolyCode **C Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```c
// Bitwise Operations — practice sketch
// add your code here
```
