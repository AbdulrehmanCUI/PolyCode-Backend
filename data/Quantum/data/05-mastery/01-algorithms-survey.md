# Lesson 01 — Quantum Algorithms Survey
...
- Understand **quantum algorithms survey** in Quantum
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Quantum Algorithms Survey is a core topic on the PolyCode **Quantum Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```md
# Quantum Algorithms Survey — practice sketch
# add your code here
```
