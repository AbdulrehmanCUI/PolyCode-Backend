...
- Understand **capstone projects** in Quantum
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Capstone Projects is a core topic on the PolyCode **Quantum Certificate Course** path. Work through the examples, then try the exercise before moving on.
