# Lesson 06 — Quantum Software Stack
...
- Understand **quantum software stack** in Quantum
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Quantum Software Stack is a core topic on the PolyCode **Quantum Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```md
# Quantum Software Stack — practice sketch
# add your code here
```
