...
- Understand **deutsch algorithm** in Quantum
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Deutsch Algorithm is a core topic on the PolyCode **Quantum Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```md
# Deutsch Algorithm — practice sketch
# add your code here
```
