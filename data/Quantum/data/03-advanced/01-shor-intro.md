# Lesson 01 — Shor Algorithm Intro
...
- Understand **shor algorithm intro** in Quantum
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Shor Algorithm Intro is a core topic on the PolyCode **Quantum Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```md
# Shor Algorithm Intro — practice sketch
# add your code here
```
