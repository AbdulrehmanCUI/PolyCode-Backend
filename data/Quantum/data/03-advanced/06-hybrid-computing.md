# Lesson 06 — Hybrid Classical-Quantum
...
- Understand **hybrid classical-quantum** in Quantum
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Hybrid Classical-Quantum is a core topic on the PolyCode **Quantum Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```md
# Hybrid Classical-Quantum — practice sketch
# add your code here
```
