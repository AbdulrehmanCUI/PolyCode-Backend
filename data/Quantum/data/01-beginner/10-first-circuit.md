...
- Understand **your first circuit** in Quantum
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Your First Circuit is a core topic on the PolyCode **Quantum Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```md
# Your First Circuit — practice sketch
# add your code here
```
