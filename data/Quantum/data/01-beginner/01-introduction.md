# Lesson 01 — Introduction to Quantum Computing
...
- Understand **introduction to quantum computing** in Quantum
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Introduction to Quantum Computing is a core topic on the PolyCode **Quantum Certificate Course** path. Work through the examples, then try the exercise before moving on.

## Key concepts

1. **Syntax and structure** — how Quantum expresses this idea clearly
...
```md
# Introduction to Quantum Computing — practice sketch
# add your code here
```
