# Lesson 09 — Linear Algebra Refresher
...
- Understand **linear algebra refresher** in Quantum
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Linear Algebra Refresher is a core topic on the PolyCode **Quantum Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```md
# Linear Algebra Refresher — practice sketch
# add your code here
```
