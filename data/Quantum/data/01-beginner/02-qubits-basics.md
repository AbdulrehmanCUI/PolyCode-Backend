# Lesson 02 — Qubits and Superposition
...
- Understand **qubits and superposition** in Quantum
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Qubits and Superposition is a core topic on the PolyCode **Quantum Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```md
# Qubits and Superposition — practice sketch
# add your code here
```
