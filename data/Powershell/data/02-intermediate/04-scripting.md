# Lesson 04 — Scripting Best Practices
...
- Understand **scripting best practices** in Powershell
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Scripting Best Practices is a core topic on the PolyCode **Powershell Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```ps1
# Scripting Best Practices — practice sketch
# add your code here
```
