# PolyCode Powershell Certificate Course
...
| 02 | `02-intermediate` | Intermediate | 6 lessons |
| 03 | `03-advanced` | Advanced | 7 lessons |
| 04 | `04-professional` | Professional | 6 lessons |
| 05 | `05-mastery` | Mastery | 4 lessons |

## Legacy content

Older topic folders (`tutorials/`, `basics/`, `projects/`, etc.) remain available for reference. **Follow the numbered modules above** for the certificate path.
