...
- Understand **automation patterns** in Powershell
- Read and write small examples you can run locally
- Connect this topic to the next lesson in the course

## Overview

Automation Patterns is a core topic on the PolyCode **Powershell Certificate Course** path. Work through the examples, then try the exercise before moving on.
...
```ps1
# Automation Patterns — practice sketch
# add your code here
```
